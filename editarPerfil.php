      ...
      <div class="col">
        <form action="formulario.php" method="POST" enctype="multipart/form-data">
          ...
          ?>
            ...
            <br>
            <br>
            <h6>Adjunte documentación para validar su información</h6>
            <form action="formulario.php" method="POST" enctype="multipart/form-data">
              <div class="input-group">
                ...
                <input class="form-control" type="file" id="fileInput" name="archivo" requierd>
                <input type="submit" disabled="disabled" name="verificacion" value="Solicitar verificacion">
          ...
          <div class="row g-2">
            <div class="col-md">
              <div class="form-floating">
                <input type="number" name="edad" aria-setsize="2" class="form-control" id="floatingInputGrid" placeholder="" value="<?php echo ("$edad") ?>">
