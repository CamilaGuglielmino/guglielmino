  ...
  <main>
    ...
    <div class="contenedor">
      <form method="POST" enctype="multipart/form-data" action="BDalojamiento.php?ID=<?php echo $ID; ?>">
        ...
        <div class="row">
          <div class="col">
            <h4 class="titulo"> Datos del Propietario:</h4>
          ...
          <div class="col">
            <h4 class="titulo"> Detalles de la oferta:</h4>
            <div class="mb-3">
        ...
        <div class="row">
          <p style="align-items: center; color: rgb(145, 97, 191)"> _________________________________________________________________________________________________________________________________</p>
        ...
        <div class="row">
          <div class="col">
            <div class="form-floating">
              <input type="text" class=" form-control" id="floatingInputGrid" placeholder="ciudad" name="ciudad">
              <label for="floatingInputGrid" class="label">Ciudad</label>
            </div>
          </div>
          <div class="col">
            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="provincia">
        ...
        <div class="row">
          <div class="col-4">
            <div class="form-floating">
              <input type="text" class="form-control" id="floatingInputGrid" placeholder="" name="direccion">
              <label for="floatingInputGrid" class="label">Direccion</label>
            </div>
          </div>
          <div class="col-4">
            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg " name="tipoPropiedad">>

              <option selected>Elija un tipo de propiedad</option>
        ...
        <div class="row">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="wifi" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
              Wifi
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="cocina" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
              Cocina
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="lavarropas" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
              Lavarropas
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="aireacondicionado" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
              Aire Acondicionado
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="televisor" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
              televisor
            </label>
          </div>
          ...
          <div class="col">
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="cochera" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
              Cochera
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="calefaccion" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
            Calefacci&oacuten 
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="zonadetrabajo" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
            Zona de trabajo 
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="pileta" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
            Pileta 
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="servicios[]" value="limpieza" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
        ...
        <div class="row">
          ...
          <div class="col">
          <h5 style="color: rgb(145, 97, 191)">Ingrese imagenes de la propiedad</h5>
