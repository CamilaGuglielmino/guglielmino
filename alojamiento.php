  ...
  ?>
      ...
      <div class="row-cols-auto">
        <div class="card text-center">
          <form method="post" action="mostrar/tarjeta_reserva.php" >
          <div class="card-header">
            Reserva
            <a name="idusuario"> <?php echo $idusuario ?></a>
            <a name="idalojamiento"> <?php echo $idalojamiento ?></a>

          </div>
          <div class="card-body">
            <h5 class="card-title"><?php echo $record['titulo']; ?></h5>
            <p class="card-text">
              Fecha inicio: <input type="date" name="inicioOferta"> 

              Fecha fin: <input type="date" name="finOferta">
            </p>
            <input type="submit" class="submitBtn" name="registrase" value="Registro">
          </div>
          </form>
        </div>
      </div>
