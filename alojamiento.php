            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img_alojamientos/descarga (1).jpeg" class="d-block w-50 h-50" alt="..." style="align-content: center !important;">
                    </div>
                    <div class="carousel-item">
                        <img src="img_alojamientos/descarga (1).jpeg" class="d-block w-50 h-50" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img_alojamientos/descarga (1).jpeg" class="d-block w-50 h-50" alt="...">
                    </div>
